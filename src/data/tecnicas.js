/* ============================================================
   src/data/técnicas.js
   El contenido educativo: métodos de ahorro explicados en simple
   y las píldoras cortas del pie de pantalla.
   Es TEXTO, no lógica. Quien decide cuando mostrarlo es
...
const Tecnicas = (() => {
  ...
  const TECNICAS = [
    ...
    },
    {
      ...
      cuerpo: `
        ...
        <p>Da vuelta el orden. El mismo día que te pagan, aparta primero tu ahorro (aunque sea el 5%) y recién después vive con el resto.</p>
        <ul>
          <li>Empieza con una cifra que <em>no duela</em>: si el 20% te asusta, parte con 5%.</li>
          <li>Programa una transferencia automática el día del pago. Lo automático gana a la fuerza de voluntad.</li>
          <li>Guárdalo en una cuenta distinta a la de tus gastos diarios.</li>
        </ul>
        <p><strong>En la app:</strong> anota ese traspaso como gasto en la categoría 🐷 Ahorro. Así lo ves reflejado en tu reparto del mes.</p>`,
    },
    {
      emoji: '🛟',
    ...
    },
    {
      ...
      cuerpo: `
        ...
        <p><strong>En la app:</strong> anda a Ajustes → Topes por categoría. Vas a ver una barra que se llena y se pone roja al pasarte.</p>`,
    },
    {
      emoji: '🐜',
    ...
    },
    {
      ...
      nivel: 'medio',
      resumen: 'Ahorrar de a poquito y terminar el año con una cifra seria.',
      cuerpo: `
    ...
    {
      emoji: '📓',
      titulo: 'Kakebo (el método japonés)',
      nivel: 'medio',
      resumen: 'Antes de gastar, pregúntate cuatro cosas.',
      cuerpo: `
    ...
    },
    {
      ...
      cuerpo: `
        ...
        <ul>
          <li>A los 10 años: aportaste 6.000.000 y tienes cerca de 8.200.000.</li>
    ...
    {
      emoji: '🔁',
      titulo: 'Revisión mensual de 15 minutos',
      nivel: 'medio',
      resumen: 'El hábito que sostiene todos los demás.',
      cuerpo: `
  ...
  /** Un consejo corto y rotativo, distinto cada día. */
  const PILDORAS = [
    ...
    'Un mes malo es información, no un fracaso. Lo único grave es dejar de mirar.',
    'Si tus ingresos son variables, presupuesta con tu peor mes, no con el mejor.',
    'Anota también lo que ganas. Ver ingresos y gastos juntos cambia las decisiones.',
  ];
