/* ============================================================
   consejos.js - La parte que ENSENA.
   Dos cosas viven aqui:
     1. TECNICAS: metodos de ahorro explicados en simple.
     2. sugerir(): mira tus numeros reales y te dice algo util.
   ============================================================ */
...
const Consejos = (() => {
  ...
  /* ------------------------------------------------------------
     ...
     ------------------------------------------------------------ */
  function sugerir(anio, mes) {
    const r = Datos.resumenDelMes(anio, mes);
    const cats = Datos.gastosPorCategoria(anio, mes);
    const presu = Datos.estadoPresupuestos(anio, mes);
    const hormiga = Datos.gastosHormiga(anio, mes);
    const reparto = Datos.reparto503020(anio, mes);
    const $ = Datos.formatearDinero;
    const lista = [];
  ...
  return { TECNICAS, sugerir, pildoraDelDia };
})();
